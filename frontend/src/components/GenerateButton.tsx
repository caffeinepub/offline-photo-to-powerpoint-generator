...
import { Download, FileText, Loader2, FileImage } from 'lucide-react';
...
export default function GenerateButton({ photos, onComplete }: GenerateButtonProps) {
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              ...
              <p className="text-sm text-muted-foreground">
                {photos.length} {photos.length === 1 ? 'photo' : 'photos'} will be organized into{' '}
                {slideCount} {slideCount === 1 ? 'slide' : 'slides'} (8 photos per slide)
              </p>
            </div>
          </div>
          ...
          {isGenerating && (
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground text-center">
                {isGeneratingPPT ? 'Generating PowerPoint' : 'Generating PDF'}... {progress}%
              </p>
            </div>
          )}
