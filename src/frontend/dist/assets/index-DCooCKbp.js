...
var b = ["light", "dark"], I = "(prefers-color-scheme: dark)", O = typeof window == "undefined", x = reactExports.createContext(void 0), U = { setTheme: (e) => {
  ...
  let [c, n] = reactExports.useState(() => H(m, l)), [T, y] = reactExports.useState(() => c === "system" ? E() : c), k = d ? Object.values(d) : a, S = reactExports.useCallback((o) => {
    ...
    if (!r2) return;
    o === "system" && s && (r2 = E());
    let v2 = d ? d[r2] : r2, C = i ? W(p) : null, P = document.documentElement, L = (g) => {
...
var ve = (n) => {
  ...
  let { invert: e, toast: t, unstyled: a, interacting: u, setHeights: f, visibleToasts: w, heights: S, index: g, toasts: i, expanded: D, removeToast: T, defaultRichColors: F, closeButton: et, style: ut, cancelButtonStyle: ft, actionButtonStyle: l, className: ot = "", descriptionClassName: at = "", duration: X2, position: st, gap: pt, loadingIcon: rt, expandByDefault: B, classNames: s, icons: P, closeButtonAriaLabel: nt = "Close toast", pauseWhenPageIsHidden: it } = n, [Y, C] = React2.useState(null), [lt, J2] = React2.useState(null), [W2, H2] = React2.useState(false), [A, mt] = React2.useState(false), [L, z2] = React2.useState(false), [ct, d] = React2.useState(false), [h, y] = React2.useState(false), [R, j] = React2.useState(0), [p, _2] = React2.useState(0), O2 = React2.useRef(t.duration || X2 || Wt), G = React2.useRef(null), k = React2.useRef(null), Vt = g === 0, Ut = g + 1 <= w, N2 = t.type, V2 = t.dismissible !== false, Kt = t.className || "", Xt = t.descriptionClassName || "", dt = React2.useMemo(() => S.findIndex((r2) => r2.toastId === t.id) || 0, [S, t.id]), Jt = React2.useMemo(() => {
    var r2;
    return (r2 = t.closeButton) != null ? r2 : et;
  }, [t.closeButton, et]), Tt = React2.useMemo(() => t.duration || X2 || Wt, [t.duration, X2]), gt = React2.useRef(0), U2 = React2.useRef(0), St = React2.useRef(0), K = React2.useRef(null), [Gt, Qt] = st.split("-"), Rt = React2.useMemo(() => S.reduce((r2, m, c) => c >= dt ? r2 : r2 + m.height, 0), [S, dt]), Et = Ft(), qt = t.invert || e, ht = N2 === "loading";
  U2.current = React2.useMemo(() => dt * pt + Rt, [dt, Rt]), React2.useEffect(() => {
    ...
    if (r2) {
      ...
      return _2(m), f((c) => [{ toastId: t.id, height: m, position: t.position }, ...c]), () => f((c) => c.filter((b2) => b2.toastId !== t.id));
    }
    ...
    r2.style.height = m, _2(c), f((b2) => b2.find((x2) => x2.toastId === t.id) ? b2.map((x2) => x2.toastId === t.id ? { ...x2, height: c } : x2) : [{ toastId: t.id, height: c, position: t.position }, ...b2]);
  ...
  React2.useEffect(() => {
    ...
    return D || u || it && Et ? (() => {
      ...
      O2.current !== 1 / 0 && (gt.current = (/* @__PURE__ */ new Date()).getTime(), r2 = setTimeout(() => {
        var b2;
        (b2 = t.onAutoClose) == null || b2.call(t, t), $();
      }, O2.current));
    })(), () => clearTimeout(r2);
  }, [D, u, t, N2, it, Et, $]), React2.useEffect(() => {
    t.delete && $();
  }, [$, t.delete]);
  function Zt() {
    var r2, m, c;
    return P != null && P.loading ? React2.createElement("div", { className: M(s == null ? void 0 : s.loader, (r2 = t == null ? void 0 : t.classNames) == null ? void 0 : r2.loader, "sonner-loader"), "data-visible": N2 === "loading" }, P.loading) : rt ? React2.createElement("div", { className: M(s == null ? void 0 : s.loader, (m = t == null ? void 0 : t.classNames) == null ? void 0 : m.loader, "sonner-loader"), "data-visible": N2 === "loading" }, rt) : React2.createElement(Yt, { className: M(s == null ? void 0 : s.loader, (c = t == null ? void 0 : t.classNames) == null ? void 0 : c.loader), visible: N2 === "loading" });
  }
  return React2.createElement("li", { tabIndex: 0, ref: k, className: M(ot, Kt, s == null ? void 0 : s.toast, (Dt = t == null ? void 0 : t.classNames) == null ? void 0 : Dt.toast, s == null ? void 0 : s.default, s == null ? void 0 : s[N2], (Pt = t == null ? void 0 : t.classNames) == null ? void 0 : Pt[N2]), "data-sonner-toast": "", "data-rich-colors": (Nt = t.richColors) != null ? Nt : F, "data-styled": !(t.jsx || t.unstyled || a), "data-mounted": W2, "data-promise": !!t.promise, "data-swiped": h, "data-removed": A, "data-visible": Ut, "data-y-position": Gt, "data-x-position": Qt, "data-index": g, "data-front": Vt, "data-swiping": L, "data-dismissible": V2, "data-type": N2, "data-invert": qt, "data-swipe-out": ct, "data-swipe-direction": lt, "data-expanded": !!(D || B && W2), style: { "--index": g, "--toasts-before": g, "--z-index": i.length - g, "--offset": `${A ? R : U2.current}px`, "--initial-height": B ? "auto" : `${p}px`, ...ut, ...t.style }, onDragEnd: () => {
    z2(false), C(null), K.current = null;
  }, onPointerDown: (r2) => {
    ht || !V2 || (G.current = /* @__PURE__ */ new Date(), j(U2.current), r2.target.setPointerCapture(r2.pointerId), r2.target.tagName !== "BUTTON" && (z2(true), K.current = { x: r2.clientX, y: r2.clientY }));
  }, onPointerUp: () => {
    var x2, Q, q, Z;
    if (ct || !V2) return;
    K.current = null;
    let r2 = Number(((x2 = k.current) == null ? void 0 : x2.style.getPropertyValue("--swipe-amount-x").replace("px", "")) || 0), m = Number(((Q = k.current) == null ? void 0 : Q.style.getPropertyValue("--swipe-amount-y").replace("px", "")) || 0), c = (/* @__PURE__ */ new Date()).getTime() - ((q = G.current) == null ? void 0 : q.getTime()), b2 = Y === "x" ? r2 : m, I2 = Math.abs(b2) / c;
    if (Math.abs(b2) >= ye || I2 > 0.11) {
      j(U2.current), (Z = t.onDismiss) == null || Z.call(t, t), J2(Y === "x" ? r2 > 0 ? "right" : "left" : m > 0 ? "down" : "up"), $(), d(true), y(false);
      return;
    }
    z2(false), C(null);
  }, onPointerMove: (r2) => {
    var Q, q, Z, zt;
    if (!K.current || !V2 || ((Q = window.getSelection()) == null ? void 0 : Q.toString().length) > 0) return;
    let c = r2.clientY - K.current.y, b2 = r2.clientX - K.current.x, I2 = (q = n.swipeDirections) != null ? q : xe(st);
...
var $e = reactExports.forwardRef(function(e, t) {
  ...
  return React2.useEffect(() => v.subscribe((d) => {
    ...
    if (T === "system" && (window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches ? H2("dark") : H2("light")), typeof window == "undefined") return;
    ...
    var j;
    let [y, R] = d.split("-");
    return B.length ? React2.createElement("ol", { key: d, dir: ot === "auto" ? _t() : ot, tabIndex: -1, ref: A, className: g, "data-sonner-toaster": true, "data-theme": W2, "data-y-position": y, "data-lifted": Y && B.length > 1 && !w, "data-x-position": R, style: { "--front-toast-height": `${((j = nt[0]) == null ? void 0 : j.height) || 0}px`, "--width": `${he}px`, "--gap": `${at}px`, ...ut, ...Te(i, D) }, onBlur: (p) => {
...
const SwitchCamera = createLucideIcon("switch-camera", __iconNode$3);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t bg-muted/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center text-sm text-muted-foreground", children: [
    "© 2025. Built with",
    " ",
    /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "inline-block w-4 h-4 text-red-500 fill-red-500 mx-1" }),
    "using",
    " ",
...
function loadJsPDF() {
  return new Promise((resolve, reject) => {
    ...
    script.onload = () => {
      var _a2;
      if ((_a2 = window == null ? void 0 : window.jspdf) == null ? void 0 : _a2.jsPDF) {
        resolve(
          window.jspdf.jsPDF
        );
      } else {
...
async function renderDeKriminatorsSlideToCanvas(width, height) {
  return new Promise((resolve, reject) => {
...
async function renderGlobalPestSlideToCanvas(width, height) {
  return new Promise((resolve, reject) => {
    const canvas = document.createElement("canvas");
    const ctx = canvas.getContext("2d");
    if (!ctx) {
...
async function renderSlideToCanvasAsync(photos, width, height) {
  const canvas = document.createElement("canvas");
  const ctx = canvas.getContext("2d");
  if (!ctx) {
  ...
  for (let i = 0; i < photos.length && i < 8; i++) {
    ...
    const x2 = padding + col * (imageWidth + gap);
    ...
    await new Promise((resolveImg) => {
      ...
      img.onload = () => {
        ...
        if (imgAspect > boxAspect) {
          ...
          drawX = x2 + (imageWidth - drawWidth) / 2;
        }
        ctx.drawImage(img, drawX, drawY, drawWidth, drawHeight);
...
async function renderSlideToCanvas(photos, width, height) {
  return renderSlideToCanvasAsync(photos, width, height);
}
async function generatePDF(photos) {
  try {
    ...
    const deKriminatorsSlideImage = await renderDeKriminatorsSlideToCanvas(
      pageWidth,
      pageHeight
    );
    pdf.addImage(
      deKriminatorsSlideImage,
      "JPEG",
      0,
      0,
      pageWidth,
    ...
    pdf.addPage();
    const globalPestSlideImage = await renderGlobalPestSlideToCanvas(
      pageWidth,
      pageHeight
    );
    pdf.addImage(
      globalPestSlideImage,
      "JPEG",
      0,
      0,
      pageWidth,
    ...
    const fileName = `photos-presentation-${(/* @__PURE__ */ new Date()).toISOString().split("T")[0]}.pdf`;
    pdf.save(fileName);
  } catch (error) {
...
async function loadTemplateImage(imagePath) {
  return new Promise((resolve, reject) => {
    const img = new Image();
    img.crossOrigin = "anonymous";
    img.onload = () => {
...
async function generatePowerPoint(photos) {
  try {
    ...
    pptx.defineSlideMaster({
      ...
      objects: [],
      slideNumber: { x: 0, y: 0, w: 0, h: 0, fontSize: 0, color: "FFFFFF" }
      // Hide slide numbers
    });
    let deKriminatorsImageData;
    let globalPestImageData;
    try {
      deKriminatorsImageData = await loadTemplateImage(
        "/assets/IMG_20260113_141006-1.jpg"
      );
      globalPestImageData = await loadTemplateImage(
        "/assets/IMG_20260113_140013-3.jpg"
      );
    } catch (error) {
    ...
    for (let slideIndex = 0; slideIndex < slidesData.length; slideIndex++) {
      ...
      for (let i = 0; i < slidePhotos.length; i++) {
        ...
        const col = i % cols;
        const row = Math.floor(i / cols);
        const x2 = startX + col * (imageWidth + gapX);
        ...
        slide.addText(photo.locationName, {
          ...
          valign: "middle",
          isTextBox: true
          // Ensure it's an editable text box
        });
      }
    }
    const fileName = `photos-presentation-${(/* @__PURE__ */ new Date()).toISOString().split("T")[0]}.pptx`;
...
function GenerateButton({ photos }) {
  const [isGeneratingPPT, setIsGeneratingPPT] = reactExports.useState(false);
  const [isGeneratingPDF, setIsGeneratingPDF] = reactExports.useState(false);
  const [progress, setProgress] = reactExports.useState(0);
  const handleGeneratePPT = async () => {
    if (photos.length === 0) {
      ue.error("No photos to generate presentation");
      return;
    }
    ...
    try {
      ...
      clearInterval(progressInterval);
      setProgress(100);
      ue.success("PowerPoint generated successfully!");
      setTimeout(() => {
      ...
      console.error("Error generating PowerPoint:", error);
      ue.error("Failed to generate PowerPoint. Please try again.");
      setIsGeneratingPPT(false);
      setProgress(0);
    }
  };
  const handleGeneratePDF = async () => {
    if (photos.length === 0) {
      ue.error("No photos to generate PDF");
      return;
    }
    ...
    try {
      ...
      clearInterval(progressInterval);
      setProgress(100);
      ue.success("PDF generated successfully!");
      setTimeout(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-2 border-primary/20 bg-gradient-to-br from-primary/5 to-transparent", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    isGenerating && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          size: "lg",
          variant: "default",
          children: isGeneratingPPT ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          children: isGeneratingPDF ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(FileImage, { className: "w-5 h-5 mr-2" }),
            "Download PDF"
          ] })
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground text-center", children: "PPT: Editable presentation • PDF: Compressed, high-quality images" })
  ] }) }) });
}
function Header() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-16 items-center justify-between", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center w-10 h-10 rounded-lg bg-gradient-to-br from-primary to-primary/60", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Image$1, { className: "w-6 h-6 text-primary-foreground" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-lg font-semibold", children: "Photo to PPTX" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Create presentations instantly" })
    ] })
  ] }) }) }) });
}
...
const useCamera = (config = {}) => {
  ...
  reactExports.useEffect(() => {
    var _a2;
    const supported = !!((_a2 = navigator.mediaDevices) == null ? void 0 : _a2.getUserMedia);
...
function PhotoCapture({ onPhotoAdd }) {
  const [locationName, setLocationName] = reactExports.useState("");
  const [capturedImage, setCapturedImage] = reactExports.useState(null);
  const [_selectedFile, setSelectedFile] = reactExports.useState(null);
  const [previewUrl, setPreviewUrl] = reactExports.useState(null);
  const [activeTab, setActiveTab] = reactExports.useState(
    "camera"
  );
  const [bulkUploads, setBulkUploads] = reactExports.useState([]);
  const fileInputRef = reactExports.useRef(null);
  const bulkFileInputRef = reactExports.useRef(null);
  const {
    isActive,
    isSupported,
    error: cameraError,
  ...
  const handleBulkFileInputChange = (e) => {
    const files = e.target.files;
    if (!files || files.length === 0) return;
    const newBulkUploads = [];
    let validFiles = 0;
    for (const file of Array.from(files)) {
      if (!file.type.startsWith("image/")) {
        ue.error(`${file.name} is not a valid image file`);
        continue;
      }
      if (file.size > 10 * 1024 * 1024) {
        ue.error(`${file.name} exceeds 10MB size limit`);
        continue;
      }
      validFiles++;
      const reader = new FileReader();
      reader.onload = (e2) => {
        var _a2;
        const dataUrl = (_a2 = e2.target) == null ? void 0 : _a2.result;
        newBulkUploads.push({
          file,
          previewUrl: dataUrl,
          locationName: ""
  ...
  const handleAddPhoto = () => {
    if (!locationName.trim()) {
      ue.error("Please enter a location name");
      return;
    }
    let imageData = null;
    ...
    if (!imageData) {
      ue.error("Please capture or select a photo first");
      return;
    }
  ...
  const handleBulkLocationChange = (index2, value) => {
    setBulkUploads(
      (prev) => prev.map(
        (item, i) => i === index2 ? { ...item, locationName: value } : item
      )
    );
  };
  const handleRemoveBulkItem = (index2) => {
    setBulkUploads((prev) => prev.filter((_2, i) => i !== index2));
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Tabs,
    {
      value: activeTab,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "grid w-full grid-cols-3 mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "camera", className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Camera, { className: "w-4 h-4" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Take Photo" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sm:hidden", children: "Camera" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "upload", className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { className: "w-4 h-4" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Upload Photo" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sm:hidden", children: "Upload" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "bulk", className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { className: "w-4 h-4" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Bulk Upload" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sm:hidden", children: "Bulk" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "camera", className: "space-y-4", children: [
          isSupported === false && /* @__PURE__ */ jsxRuntimeExports.jsx(Alert, { variant: "destructive", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDescription, { children: "Camera is not supported on this device or browser." }) }),
          cameraError && /* @__PURE__ */ jsxRuntimeExports.jsx(Alert, { variant: "destructive", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDescription, { children: [
            cameraError.message,
            cameraError.type === "permission" && /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                variant: "outline",
                size: "sm",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: !capturedImage ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-video bg-muted rounded-lg overflow-hidden", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "video",
                {
                  ref: videoRef,
              ...
              !isActive && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Camera, { className: "w-12 h-12 text-muted-foreground" }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: !isActive ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: handleCapturePhoto, className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Camera, { className: "w-4 h-4 mr-2" }),
                "Capture Photo"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(SwitchCamera, { className: "w-4 h-4" })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative aspect-video rounded-lg overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: capturedImage,
                alt: "Captured",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "upload", className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            ...
            previewUrl ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              ...
              "label",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { className: "w-12 h-12 text-muted-foreground mb-3" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium mb-1", children: "Click to upload" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "PNG, JPG, WebP up to 10MB" })
                ]
              }
            )
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "bulk", className: "space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "label",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { className: "w-12 h-12 text-muted-foreground mb-3" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium mb-1", children: "Click to select multiple photos" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "PNG, JPG, WebP up to 10MB each" })
              ]
            }
          ),
          bulkUploads.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 max-h-96 overflow-y-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between mb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-medium", children: [
              bulkUploads.length,
              " photo",
              bulkUploads.length > 1 ? "s" : "",
              " selected"
            ] }) }),
            bulkUploads.map((item, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: "flex gap-3 p-3 border rounded-lg bg-muted/30",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative w-20 h-20 flex-shrink-0 rounded overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "img",
                    {
                      src: item.previewUrl,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 space-y-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground truncate", children: item.file.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Input,
                      {
                        placeholder: "Enter location name",
                        value: item.locationName,
                        onChange: (e) => handleBulkLocationChange(index2, e.target.value),
                        className: "h-9"
                      }
                    )
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      variant: "ghost",
                      size: "icon",
                      onClick: () => handleRemoveBulkItem(index2),
          ...
          bulkUploads.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
...
function PhotoList({ photos, onRemove }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-xl font-semibold", children: [
      "Added Photos",
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "secondary", className: "ml-3", children: [
        photos.length,
        " ",
        photos.length === 1 ? "photo" : "photos"
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "h-[400px] pr-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-3", children: photos.map((photo, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "group relative rounded-lg border bg-card overflow-hidden transition-all hover:shadow-md",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-2 left-2 z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "secondary", className: "font-semibold", children: [
            "#",
            index2 + 1
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-2 right-2 z-10 opacity-0 group-hover:opacity-100 transition-opacity", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              variant: "destructive",
              size: "icon",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-video relative overflow-hidden bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: photo.imageData,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium line-clamp-2", children: photo.locationName })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: formatDate(photo.timestamp) })
          ] })
        ]
      },
      photo.id
...
function App() {
  ...
  reactExports.useEffect(() => {
    try {
      ...
      ue.error("Failed to load saved photos");
    } finally {
      setIsLoading(false);
    }
  }, []);
  reactExports.useEffect(() => {
    if (!isLoading) {
      try {
        ...
        ue.error("Failed to save photos. Storage may be full.");
      }
    }
  }, [photos, isLoading]);
  const addPhoto = (imageData, locationName) => {
    ...
    ue.success("Photo added successfully");
  };
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(J, { attribute: "class", defaultTheme: "system", enableSystem: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-muted-foreground", children: "Loading..." })
    ] }) }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(J, { attribute: "class", defaultTheme: "system", enableSystem: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-h-screen flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 py-6 md:py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-5xl space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold tracking-tight md:text-4xl bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent", children: "Photo to PowerPoint Generator" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground max-w-2xl mx-auto", children: "Capture or upload photos with location names and generate a PowerPoint presentation offline" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(PhotoCapture, { onPhotoAdd: addPhoto }),
      photos.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(PhotoList, { photos, onRemove: removePhoto }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(GenerateButton, { photos, onComplete: clearAllPhotos })
      ] }),
      photos.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center justify-center w-16 h-16 rounded-full bg-muted mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "svg",
          {
            ...
            role: "img",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Camera icon" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "path",
                {
                  strokeLinecap: "round",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "No photos added yet. Start by capturing or uploading your first photo above." })
      ] })
    ] }) }) }),
